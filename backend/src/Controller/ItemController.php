...
use Proxies\__CG__\App\Entity\PreguntaQuizz;
...
final class ItemController extends AbstractController
{
    ...
    #[Route('/api/item/{id}/quiz/{quizId}/start', name: 'app_item_quiz_start', methods: ['POST'])]
    ...
    #[Route('/api/item/{id}/quiz/{quizId}/preguntas/{intentoId}', name: 'app_item_quiz_preguntas', methods: ['GET'])]
    ...
    #[Route('/api/item/{id}/quiz/{quizId}/submit/{intentoId}', name: 'app_item_quiz_submit', methods: ['POST'])]
    ...
    #[Route('/api/item/{id}/quiz/{quizId}/check-abandoned/{intentoId}', name: 'app_item_quiz_check_abandoned', methods: ['POST'])]
