 ...
 */
final class Version20250508174345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE curso (id INT AUTO_INCREMENT NOT NULL, imagen_id INT DEFAULT NULL, profesor_id INT NOT NULL, nombre VARCHAR(100) NOT NULL, fecha_creacion DATETIME NOT NULL, descripcion LONGTEXT NOT NULL, INDEX IDX_CA3B40EC763C8AA7 (imagen_id), INDEX IDX_CA3B40ECE52BD977 (profesor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE entrega_tarea (id INT AUTO_INCREMENT NOT NULL, id_tarea_id INT NOT NULL, usuario_curso_id INT DEFAULT NULL, fichero_id INT DEFAULT NULL, fecha_entrega DATETIME DEFAULT NULL, calificacion NUMERIC(4, 2) DEFAULT NULL, puntos_obtenidos INT DEFAULT NULL, comentario_profesor VARCHAR(255) DEFAULT NULL, estado VARCHAR(100) DEFAULT \'pendiente\' NOT NULL, comentario_estudiante VARCHAR(255) DEFAULT NULL, INDEX IDX_87CDD04C3D803374 (id_tarea_id), INDEX IDX_87CDD04C6F0AB886 (usuario_curso_id), UNIQUE INDEX UNIQ_87CDD04C8E05855 (fichero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fichero (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, nombre_original VARCHAR(255) NOT NULL, ruta VARCHAR(255) NOT NULL, mime_type VARCHAR(100) NOT NULL, fecha_subida DATETIME NOT NULL, tamanio INT NOT NULL, INDEX IDX_F4E94434DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intento_quizz (id INT AUTO_INCREMENT NOT NULL, id_quizz_id INT NOT NULL, id_usuario_id INT NOT NULL, fecha_inicio DATETIME DEFAULT NULL, fecha_fin DATETIME DEFAULT NULL, puntuacion_total INT DEFAULT NULL, completado TINYINT(1) DEFAULT NULL, calificacion NUMERIC(4, 2) DEFAULT NULL, INDEX IDX_B88CE435EA48A758 (id_quizz_id), INDEX IDX_B88CE4357EB2C349 (id_usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, id_curso_id INT NOT NULL, fichero_id INT DEFAULT NULL, titulo VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, fecha_publicacion DATETIME NOT NULL, orden INT DEFAULT NULL, INDEX IDX_7CBE7595D710A68A (id_curso_id), UNIQUE INDEX UNIQ_7CBE75958E05855 (fichero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE material_completado (id INT AUTO_INCREMENT NOT NULL, usuario_curso_id INT DEFAULT NULL, material_id INT NOT NULL, fecha_completado DATETIME NOT NULL, INDEX IDX_204F3F96F0AB886 (usuario_curso_id), INDEX IDX_204F3F9E308AC6F (material_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nivel (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, puntos_requeridos INT DEFAULT 0 NOT NULL, descripcion VARCHAR(255) NOT NULL, num_nivel INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notificacion (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, tipo VARCHAR(50) NOT NULL, titulo VARCHAR(255) NOT NULL, contenido LONGTEXT NOT NULL, leida TINYINT(1) NOT NULL, url VARCHAR(255) DEFAULT NULL, fecha_creacion DATETIME NOT NULL, fecha_lectura DATETIME DEFAULT NULL, INDEX IDX_729A19ECDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quizz (id INT AUTO_INCREMENT NOT NULL, id_curso_id INT NOT NULL, titulo VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, fecha_publicacion DATETIME NOT NULL, fecha_limite DATETIME NOT NULL, tiempo_limite INT DEFAULT 30 NOT NULL, puntos_totales INT NOT NULL, intentos_permitidos INT DEFAULT 1, INDEX IDX_7C77973DD710A68A (id_curso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tarea (id INT AUTO_INCREMENT NOT NULL, id_curso_id INT NOT NULL, fichero_id INT DEFAULT NULL, titulo VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, archivo_url VARCHAR(255) DEFAULT NULL, fecha_publicacion DATETIME NOT NULL, fecha_limite DATETIME NOT NULL, puntos_maximos INT DEFAULT 100 NOT NULL, es_obligatoria TINYINT(1) DEFAULT 1 NOT NULL, INDEX IDX_3CA05366D710A68A (id_curso_id), UNIQUE INDEX UNIQ_3CA053668E05855 (fichero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE entrega_tarea ADD CONSTRAINT FK_87CDD04C6F0AB886 FOREIGN KEY (usuario_curso_id) REFERENCES usuario_curso (id)');
        ...
        $this->addSql('ALTER TABLE material ADD CONSTRAINT FK_7CBE75958E05855 FOREIGN KEY (fichero_id) REFERENCES fichero (id)');
        $this->addSql('ALTER TABLE material_completado ADD CONSTRAINT FK_204F3F96F0AB886 FOREIGN KEY (usuario_curso_id) REFERENCES usuario_curso (id)');
        $this->addSql('ALTER TABLE material_completado ADD CONSTRAINT FK_204F3F9E308AC6F FOREIGN KEY (material_id) REFERENCES material (id)');
        ...
        $this->addSql('ALTER TABLE tarea ADD CONSTRAINT FK_3CA053668E05855 FOREIGN KEY (fichero_id) REFERENCES fichero (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entrega_tarea DROP FOREIGN KEY FK_87CDD04C6F0AB886');
        ...
        $this->addSql('ALTER TABLE material DROP FOREIGN KEY FK_7CBE75958E05855');
        $this->addSql('ALTER TABLE material_completado DROP FOREIGN KEY FK_204F3F96F0AB886');
        $this->addSql('ALTER TABLE material_completado DROP FOREIGN KEY FK_204F3F9E308AC6F');
        ...
        $this->addSql('ALTER TABLE tarea DROP FOREIGN KEY FK_3CA053668E05855');
        ...
        $this->addSql('DROP TABLE material_completado');
