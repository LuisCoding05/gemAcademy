 ...
 */
final class Version20250412153638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entrega_tarea (id INT AUTO_INCREMENT NOT NULL, id_tarea_id INT NOT NULL, usuario_curso_id INT DEFAULT NULL, archivo_url VARCHAR(255) DEFAULT NULL, fecha_entrega DATETIME NOT NULL, calificacion NUMERIC(4, 2) DEFAULT NULL, puntos_obtenidos INT DEFAULT NULL, comentario_profesor VARCHAR(255) DEFAULT NULL, INDEX IDX_87CDD04C3D803374 (id_tarea_id), INDEX IDX_87CDD04C6F0AB886 (usuario_curso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
