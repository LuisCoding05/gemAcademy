 ...
 */
final class Version20250419125920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario_curso (id INT AUTO_INCREMENT NOT NULL, id_usuario_id INT NOT NULL, id_curso_id INT NOT NULL, fecha_inscripcion DATETIME NOT NULL, materiales_completados INT DEFAULT 0 NOT NULL, tareas_completadas INT DEFAULT 0 NOT NULL, quizzes_completados INT DEFAULT 0 NOT NULL, porcentaje_completado NUMERIC(5, 2) DEFAULT \'0\' NOT NULL, ultima_actualizacion DATETIME NOT NULL, INDEX IDX_D7E52AF27EB2C349 (id_usuario_id), INDEX IDX_D7E52AF2D710A68A (id_curso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
